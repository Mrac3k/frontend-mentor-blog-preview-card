...
This is my solution to the Blog Preview Card challenge on Frontend Mentor. The goal of this project was to recreate a responsive blog preview card based on the provided design while practicing modern HTML and CSS fundamentals.
...
**Desktop:**
![Desktop Screenshot](screenshot/computer.jpg)
...
- Live Site URL: https://mrac3k.github.io/frontend-mentor-blog-preview-card/
...
- Custom box shadow for depth effect
...
- Styling badge/tag elements with `inline-block`
- Working with spacing, typography, and color
- Applying responsive design principles
- Organizing CSS using the BEM methodology

One example from the project — creating the category badge:

```css
.card__profile--information {
...
Using `display: inline-block` allows the background to wrap tightly around the text instead of stretching across the full width.
...
For this project, I used Claude as a learning assistant rather than a code generator.

AI helped me:

- Understand HTML and CSS concepts
- Learn how to style badge/tag elements
